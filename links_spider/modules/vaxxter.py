...
class vaxxter:
    ...
    def __init__(self, url):
        ...
        self.url = url
        self.homepage = "https://vaxxter.com/"
        try:
    ...
    def get_all_links(self):
        # get the links
        all_links = []
        if self.url == self.homepage or 'https://vaxxter.com/page/' in self.url:
            content = self.html.xpath("//div[@id = 'main-content']//a/@href")
        else:
            content = self.html.xpath("//div[@class = 'entry-content mh-clearfix']//p//a/@href")
        for ele in content:
