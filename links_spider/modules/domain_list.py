...
parsable_domain_list = ['mothering.com','infowars.com','naturalnews.com', 'childrenshealthdefense.org','activistpost.com', 'ahrp.org', 'newstarget.com'
                        ,'truthwiki.org','vaxtruth.org','vactruth.com', 'vaccines.news']
moddules = [mothering, infowars, naturalnews, childrenshealthdefense, activistpost, ahrp, newstarget, truthwiki,vaxtruth,vactruth,vaccines_news]